...
An AI agent skill that manages Claude Code sessions stored on disk. Currently supports listing all
...
```bash
npx skills add qingvincentyin/claude-sessions-manager
```
